...
for forward_read in $(find /mnt/project/AntibiotiKU/hunt_rawfiles/ -type f -name "*_1.fq.gz"); do 
    ...
    bowtie2 -x /mnt/project/AntibiotiKU/bowtie_indexes/ARS-UCD1.2 -p 64 -1 $forward_read -2 $reverse_read --un-conc-gz /mnt/project/AntibiotiKU/hunt_host_removed/$sample_name.host_removed.fq ;   
done