...
find /mnt/project/AntibiotiKU/hunt_rawfiles/ -type f -name "*_1.fq.gz" | xargs -P 64 -I {} bash -c '
    ...
    bowtie2 -x /mnt/project/AntibiotiKU/bowtie_indexes/Sscrofa11.1/Sscrofa11.1 -p 1 -1 $forward_read -2 $reverse_read \
    --no-unal --no-head > /dev/null 2> /mnt/project/AntibiotiKU/hunt_host_removed/$sample_name.pig.bowtie2.log
'
