...
REGULAR_OUTPUT="${OUTPUT_BASE}/spades_assembly_output"
PLASMID_OUTPUT="${OUTPUT_BASE}/spades_plasmid_output"
...
for forward_read in "$INPUT_DIR"/*_1.fq.gz; do
    ...
    plasmid_sample_output="${PLASMID_OUTPUT}/${sample_name}"
    ...
    echo "Plasmid assembly output: $plasmid_sample_output"
    echo "------------------------------------"
done
